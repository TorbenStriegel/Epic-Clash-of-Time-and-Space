...
{
    [DataContract]
    public sealed class Tree2 : GameObject
    {

        /// <summary>
        /// Large tree which can be harvested by worker.
        /// </summary>
        public Tree2(GameLoop gameLoop) : base(gameLoop)
        ...
        private void Initialize()
        {
            ...
            mSpeed = 0;
            mFace = new Rectangle(192, 544, 80, 126);
            mIsMarked = false;
            mIsMarkable = false;
