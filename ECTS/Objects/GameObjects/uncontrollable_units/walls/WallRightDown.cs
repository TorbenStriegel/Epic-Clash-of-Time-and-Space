...
{
    [DataContract]
    internal sealed class WallRightDown: GameObject
    {
        private Rectangle mFaceBackground;          // used to display the broken wall as background.
        /// <summary>
        /// Wall for upper right corner of rectangle (goes right then down).
        /// Sprite (appearance) depends on health.
        /// </summary>
        public WallRightDown(GameLoop gameLoop) : base(gameLoop)
        {
            mGameLoop = gameLoop;
            Initialize();
        }
        ...
        private void Initialize()
        {
            ...
            mFace.X = 258; mFace.Y = 0; mFace.Width = 48; mFace.Height = 48;
            mBackgroundTextureName = "Objects/walls";
            mFaceBackground.X = 258; mFaceBackground.Y = 112; mFaceBackground.Width = mFace.Width; mFaceBackground.Height = mFace.Height;
        ...
        public override void ChangeFace(string face)
        {
            ...
            {
                mFace.X = 258; mFace.Y = 56; mFace.Width = 48; mFace.Height = 48;
            }
            ...
            mFace.X = 258; mFace.Y = 112; mFace.Width = 48; mFace.Height = 48;
        }
