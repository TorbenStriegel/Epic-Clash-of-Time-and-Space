...
{
    [DataContract]
    internal sealed class WallHorizontal: GameObject
    {
        ...
        /// </summary>
        public WallHorizontal(GameLoop gameLoop) : base(gameLoop)
        {
            mGameLoop = gameLoop;
            Initialize();
        }
        ...
        private void Initialize()
        {
            ...
            mFace.X = 52; mFace.Y = 0; mFace.Width = 48; mFace.Height = 48;
            mBackgroundTextureName = "Objects/walls";
            mFaceBackground.X = 52; mFaceBackground.Y = 112; mFaceBackground.Width = mFace.Width; mFaceBackground.Height = mFace.Height;
        ...
        public override void ChangeFace(string face)
        {
            ...
            {
                mFace.X = 52; mFace.Y = 56; mFace.Width = 48; mFace.Height = 48;
            }
            if (face.Equals("Dead"))
            {
                mFace.X = 52; mFace.Y = 112; mFace.Width = 48; mFace.Height = 48;
            }
        }
