...
{
    [DataContract]
    internal sealed class GrenadeEnemy: GameObject
    {
        ...
        /// </summary>
        public GrenadeEnemy(GameLoop gameLoop) : base(gameLoop)
        ...
        private void Initialize()
        {
            ...
            mTextureName = "Objects/GrenadeBlue";
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (mDistanceTravelled > mTravelDistance)
            {
                ...
                mGameLoop.ObjectManager.mTempTree.Add(new GrenadeEnemyExplosion(mGameLoop)
                {
