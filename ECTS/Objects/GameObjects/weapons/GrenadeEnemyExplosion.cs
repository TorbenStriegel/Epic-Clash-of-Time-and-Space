...
{
    [DataContract]
    internal sealed class GrenadeEnemyExplosion: GameObject
    {
        private AnimationManager AnimationManager { get; set; }
        /// <summary>
        /// Explosion for Grenades (and other purposes?)
        /// </summary>
        public GrenadeEnemyExplosion(GameLoop gameLoop) : base(gameLoop)
        ...
        private void Initialize()
        {
            ...
            mTextureName = "Objects/GrenadeExplosionBlue";
